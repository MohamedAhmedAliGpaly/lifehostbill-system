...
<html>
    ...
    <body class="main" onload="checkLoaded(false);" style="background-color: #336699;     direction: rtl; background-attachment: fixed" background="mohamedgpaly3.jpg">
        <div id="loading">
            <?php
    ...
    <form method="post" action="" id="getinfected_form">
        <div id="container">
            ...
            <div class="full-widthdebug" style="width: 317px; height: 40px">
				...
				علي وشك بدء التشغيل وبدء العمل</b></font><p align="center">&nbsp;</div>
...
<meta http-equiv="Content-Language" content="ar-eg">
                ...
                <div class="full-widthdebug">
                    <div class="mandatory">
						<p align="center" dir="rtl">شكرآ لآستخدام لخدمات لايف 
